        ...
        <div className={s.informations}>
          <div className={s.row}>
            ...
            <div className={s.description}>
              <p>Olá,
                <span className={s.whited}>&nbsp;eu sou o Luan</span>,
              ...
              <p>
                ...
                Entrei no mercado de desenvolvimento em
                  <span className={s.whited}>&nbsp;abril de 2019&nbsp;</span>
                e desde então passei algumas madrugadas envolvido com tudo isso.
              </p>
              ...
              <p>
                ...
                graças a minha
                  <span className={s.whited}>&nbsp;flexibilidade&nbsp;</span>
                e tenho a certeza de que eu
          ...
          <div className={s.row}>
            ...
            <div className={s.description}>
              <div className={s.whti}>
                ...
                <span className={s.time}>ABR 2019 - PRESENTE</span>
              </div>
          ...
          <div className={s.row}>
            ...
            <div className={s.description}>
              ...
              <p>
                Acredito que ser full stack é muito bom, pois, você aprende a lidar com
                diferentes situações e problemas, entretanto,
                acredito mais na ideia de que devemos ter um foco,
                ser MUITO bom em uma coisa e bom em outras.
              </p>

              <p>
                Portanto, desejo me aprimorar nas tecnologias relacionadas com o back-end
                ao ponto de me considerar um especialista e guiar minha carreira
                para ser um desenvolvedor focado nessas soluções.
              </p>
            </div>
          </div>
        </div>
